...
*
         ...
         CELGBR R0,0,R1,0    Cvt Int in GPR1 to float in FPR0
...
*
         ...
         CELGBR R0,0,R1,B'0100'  FPC controlled rounding, inexact masked
...
*
         LG    R1,0(0,R3)    Get integer test value
         LFPC  FPCREGNT      Set all exceptions non-trappable
         CDLGBR R0,0,R1,0    Cvt Int in GPR1 to float in FPR0
...
*
         LFPC  FPCREGNT      Set all exceptions non-trappable, clear flags
         SRNMB 1             SET FPC to RZ, Round towards zero.  
         CDLGBR R0,0,R1,B'0100'  FPC controlled rounding, inexact masked
...
*
         LFPC  FPCREGNT      Set all exceptions non-trappable, clear flags
         CDLGBR R0,1,R1,B'0000'  RNTA Round to nearest, ties away from zero
         STD   R0,4*8(0,R7)  Store short BFP result
         STFPC 4*4(R8)       Store resulting FPC flags and DXC
*
         LFPC  FPCREGNT      Set all exceptions non-trappable, clear flags
         CDLGBR R0,3,R1,B'0000'  RPS Round to prepare for shorter precision
         STD   R0,5*8(0,R7)  Store short BFP result
         STFPC 5*4(R8)       Store resulting FPC flags and DXC
*
         LFPC  FPCREGNT      Set all exceptions non-trappable, clear flags
         CDLGBR R0,4,R1,B'0000'  RNTE Round to nearest, ties to even
         STD   R0,6*8(0,R7)  Store short BFP result
         STFPC 6*4(R8)       Store resulting FPC flags and DXC
*
         LFPC  FPCREGNT      Set all exceptions non-trappable, clear flags
         CDLGBR R0,5,R1,B'0000'  RZ Round toward zero
         STD   R0,7*8(0,R7)  Store short BFP result
         STFPC 7*4(R8)       Store resulting FPC flags and DXC
*
         LFPC  FPCREGNT      Set all exceptions non-trappable, clear flags
         CDLGBR R0,6,R1,B'0000'  Round to +inf
         STD   R0,8*8(0,R7)  Store short BFP result
         STFPC 8*4(R8)       Store resulting FPC flags and DXC
*
         LFPC  FPCREGNT      Set all exceptions non-trappable, clear flags
         CDLGBR R0,7,R1,B'0000'  Round to -inf
...
*
         LG    R1,0(0,R3)    Get integer test value
         LFPC  FPCREGNT      Set all exceptions non-trappable
         CXLGBR R0,0,R1,0    Cvt Int in GPR1 to float in FPR0-FPR2
...
INTIN    DS    0D
         ...
         DC    FD'U2'
         DC    FD'U4'
         DC    XL8'001FFFFFFFFFFFFF'  fits in long BFP, overflows short bfp
